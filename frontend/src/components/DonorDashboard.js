...
const DonorDashboard = () => {
  ...
  // Temporarily disable recipients until API endpoint is created
  const recipients = [];
  const recipientsLoading = false;
  const refreshRecipients = () => {};
  
  // TODO: Implement /donors/recipients API endpoint in backend
  // const {
  //   data: recipients,
  ...
  //     console.log('✅ Recipients received:', response.data);
  //     return response.data || [];
  //   }, [api]),
  //   60000
  // );
  ...
  const secondaryLoading = ordersLoading || ratingSummaryLoading;
  ...
  // Error boundary for missing user data
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <h3 className="text-lg font-medium text-gray-900 mb-2">User data not available</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <CheckCircle className={`h-4 w-4 ${secondaryLoading ? 'animate-spin' : ''}`} />
              Refresh Data
            </Button>
          </div>
        </div>
          ...
          <TabsContent value="recipients" className="space-y-6">
            <div className="flex justify-between items-center">
              ...
              <Badge variant="outline" className="bg-blue-50 text-blue-700">
                {recipients?.length || 0} Total Recipients
              </Badge>
            </div>
                ...
                <Card key={recipient.recipient_id} className="card-hover">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2 pt-2 border-t border-gray-100">
                      ...
                      {(!recipient.recent_orders || recipient.recent_orders.length === 0) && (
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-lg">
                          All Orders ({selectedRecipientAllOrders ? (selectedRecipientAllOrders.recent_orders?.length || 0) : (selectedRecipient.recent_orders?.length || 0)})
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-3">
